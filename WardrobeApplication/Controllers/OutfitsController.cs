...
namespace WardrobeApplication.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OutfitID,ClosetID,OutfitName,OutfitSeason")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,ClosetID,OutfitName,OutfitSeason")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
