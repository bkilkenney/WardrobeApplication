...
namespace WardrobeApplication.Controllers
{
    public class ClosetsController : Controller
    {
        ...
        {
            var closets = db.Closets.Include(c => c.ClothingType);
        ...
        public ActionResult Create([Bind(Include = "ClothingID,ClothingTypeID,Name,Photo,Color,Season,Occasion")] Closet closet)
        {
            ...
            ViewBag.ClothingTypeID = new SelectList(db.ClothingTypes, "ClothingTypeID", "ClothingTypeName", closet.ClothingTypeID);
            return View(closet);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClothingID,ClothingTypeID,Name,Photo,Color,Season,Occasion")] Closet closet)
        {
            if (ModelState.IsValid)
            {
