...
namespace WardrobeApplication.Controllers
{
    public class ClothingTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClothingTypeID,ClothingTypeName")] ClothingType clothingType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClothingTypeID,ClothingTypeName")] ClothingType clothingType)
        {
            if (ModelState.IsValid)
            {
